...
class GIS(object):
    ...
    def geocode_address(self, address, geocoder_list):
        ...
        :Paramters:
            ...
            - 'geocoder_list': A list of string represented geocoding service providers. See geopy documentation at http://geopy.readthedocs.org/en/latest/
